...
public class TestCase7 
{
	...
	{
		logger = report.startTest("Test Case 5: School Of Dragons - Live - Create Age 13 Player (Non Authorized User) ","This will verify if user can create an non Authorized user with age 13").assignCategory("none");
